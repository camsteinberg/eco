...
export function ModelSelector() {
  ...
  // The device's honest offer: one or two models, best-first, with the everyday
  // pick recommended. Same domain call the welcome card makes, so the composer
  // and first-run never disagree.
  const offer = useMemo(() => {
    const empty = {
