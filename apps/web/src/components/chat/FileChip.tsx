...
export function FileChip({
  ...
  return (
    ...
    >
      ...
      <span style={{ color: "var(--eco-text-secondary)" }}>{formatSize(size)}</span>
      ...
      {status === "done" && (
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-2.5 w-2.5" aria-hidden="true">
