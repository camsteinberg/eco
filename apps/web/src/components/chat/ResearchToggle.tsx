 ...
 * lookups (facts via Wikipedia) that are off by default and controlled in
...
export function ResearchToggle() {
  return (
    <button
      ...
      title="Deeper research mode isn't part of web v1 yet. Everyday lookups for facts are off by default — turn them on in Settings → Eco."
