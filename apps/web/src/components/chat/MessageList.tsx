...
export function MessageList({
  ...
  return (
    ...
    >
      ...
      {/* The width caps are the reading column (42rem → 48rem at lg → 56rem at
          xl, matching MessageBubble's assistant cap) PLUS this element's own
      ...
      <div ref={contentRef} className="mx-auto flex w-full max-w-[45rem] lg:max-w-[51rem] xl:max-w-[59rem] flex-col gap-4 px-4 pb-8 pt-4 md:px-6 md:py-6">
