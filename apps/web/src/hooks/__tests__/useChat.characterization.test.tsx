...
// ═══════════════════════════════════════════════════════════════════════════
// 2. Single generation per turn (repair loop removed in R1)
// ═══════════════════════════════════════════════════════════════════════════

describe("useChat — single generation per turn", () => {
  it("runs exactly one generate() call per user message", async () => {
    setScripts([
      { kind: "tokens", tokens: ["A tasty tomato pasta."] },
    ]);
    const { result } = renderHook(() => useChat());
    await act(async () => {
