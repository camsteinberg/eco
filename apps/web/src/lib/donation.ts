...
/**
 * Optional external donation link.
 *
 * Eco is free and has no tiers, plans, or feature gates. There is no
 * server-side billing: nothing is charged, and no payment details ever reach
