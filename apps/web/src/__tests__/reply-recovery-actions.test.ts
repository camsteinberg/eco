...
const CONTROL_SAMPLING_TODAY: Readonly<Record<string, Readonly<Record<string, string>>>> = {
  continue: {
    ...
    "candidate/qwen3-0.6b-mlc-q0f16": "quick:512/0.32",
  ...
  expand: {
    ...
    "candidate/qwen3-0.6b-mlc-q0f16": "deep:512/0.6",
...
const TYPED_ROUTING_TODAY: Readonly<Record<string, string>> = {
  ...
  "candidate/qwen3-0.6b-mlc-q0f16": "writing:512/0.48",
