          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-[var(--eco-border)] bg-[var(--eco-surface-elevated)] p-5">
                ...
                <p>
                  Some questions are about right now &mdash; today&apos;s news,
                  a score, the weather &mdash; and no model running on your
                ...
                <p className="mt-3">
                  ...
                  instance, then the public search engines. The engines see
                  Eco&apos;s server making the request &mdash; its address, not
                  yours &mdash; so they cannot build a picture of you from it. No
                  cookie of yours is read or forwarded.
                </p>
                <p className="mt-3">
                  A successful search is not written to a log and is not linked
                ...
                <p className="mt-3">
                  Every reply that used a search is marked with a chip showing
                  the time it was fetched and the sources it used, so you can
                  always tell which of your turns went out and which did not.
                  Turn it on or off at any time in Settings &rarr; Eco or from
                  the Web switch beside the message box; with it off, nothing is
                  searched and your questions stay on your device.
                </p>
              </div>
            </div>
          </section>
