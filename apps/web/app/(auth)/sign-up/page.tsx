      ...
      <div className="relative z-10 w-full max-w-[28rem]">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-[color-mix(in_srgb,var(--color-border),var(--color-accent)_15%)] bg-[var(--color-surface-raised)] p-6 shadow-sm sm:p-12">
          ...
          <form noValidate onSubmit={handleSubmit} className="relative mt-6 space-y-4">
            ...
            {/* Submit */}
            <Button type="submit" variant="primary" size="lg" fullWidth loading={isBusy}>
              Create account
            </Button>
          </form>
          ...
          <div className="relative space-y-2.5">
            {googleEnabled && (
              <Button type="button" variant="secondary" size="lg" fullWidth className="rounded-full" onClick={() => handleOAuth("google")}>
            ...
            {githubEnabled && (
              <Button type="button" variant="secondary" size="lg" fullWidth className="rounded-full" onClick={() => handleOAuth("github")}>
